...
public class ConsoleEng {
    ...
    //method 6
    public  void printNextSeason(MonthEng month) {
        System.out.print("Next season for " + month + " is ");
        switch (month) {
            case DECEMBER:
            case JANUARY:
            case FEBRUARY:
                System.out.println(SeasonsEng.Spring);
                break;
            case MARCH:
            case APRIL:
            case MAY:
                System.out.println(SeasonsEng.Summer);
                break;
            case JUNE:
            case JULY:
            case AUGUST:
                System.out.println(SeasonsEng.Autumn);
                break;
            case SEPTEMBER:
            case OCTOBER:
            case NOVEMBER:
                System.out.println(SeasonsEng.Winter);
                break;
            default:
    ...
    //method 7
    public void printPreviousSeason(MonthEng month) {
    ...
    public void evenMonth (){
        ...
        for (MonthEng d : MonthEng.values()){
