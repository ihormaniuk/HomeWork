...
public class ConsoleUa {
    ...
    public  void printNextSeason(MonthUa monthUa) {
        ...
        switch (monthUa) {
            ...
            case Січень:
            case Лютий:
                System.out.println(SeasonsUa.Весна);
                break;
            case Березень:
            case Квітень:
            case Травень:
                System.out.println(SeasonsUa.Літо);
                break;
            case Червень:
            case Липень:
            case Серпень:
                System.out.println(SeasonsUa.Осінь);
                break;
            case Вересень:
            case Жовтень:
            case Листопад:
                System.out.println(SeasonsUa.Зима);
                break;
            default:
            ...
            if(scan.hasNextInt()){
                ...
                switch (number){
                    case 1: {
                        ...
                        monthUa.check ( monthUa.readMonth () );
